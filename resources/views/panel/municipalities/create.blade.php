...
@section('title', __('Create Municipality'))
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb border bg-white shadow-sm">
        ...
        <li class="breadcrumb-item pr-1">
            <a href="{{ route('panel.municipalities.create') }}">{{ __('Create Municipality') }}</a>
        </li>
    </ol>
</nav>

<div class="card shadow-sm">
    <div class="card-header bg-transparent">{{ __('Create Municipality') }}</div>

    <div class="card-body">
        <form action="{{ route('panel.municipalities.store') }}" method="post" autocomplete="off">
            @csrf
