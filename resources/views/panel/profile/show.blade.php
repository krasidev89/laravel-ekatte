...
<div id="accordionProfile" class="accordion">
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center bg-transparent border-0" data-toggle="collapse" data-target="#collapseUpdate" aria-expanded="{{ $collapseUpdateExpanded ? 'true' : 'false' }}" aria-controls="collapseUpdate">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="form-group">
                                ...
                                @php
                                    $oldRole = old('role', optional(optional(auth()->user()->roles)->pluck('id'))->first());
                                @endphp
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center bg-transparent border-0" data-toggle="collapse" data-target="#collapseUpdatePassword" aria-expanded="{{ $collapseUpdatePassword ? 'true' : 'false' }}" aria-controls="collapseUpdatePassword">
            <div class="card-title mb-0">{{ __('Update Password') }}</div>
            <i class="plus-minus-rotate flex-shrink-0 ml-auto collapsed"></i>
        </div>
    ...
    @if (Route::has('panel.profile.destroy'))
    <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center bg-transparent border-0" data-toggle="collapse" data-target="#collapseDeleteAccount" aria-expanded="false" aria-controls="collapseDeleteAccount">
            <div class="card-title text-danger mb-0">{{ __('Delete Account') }}</div>
            <i class="plus-minus-rotate flex-shrink-0 ml-auto collapsed"></i>
        </div>
