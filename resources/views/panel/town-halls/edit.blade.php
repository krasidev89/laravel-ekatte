...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb border bg-white shadow-sm">
        ...
        <li class="breadcrumb-item pr-1">
            <a href="{{ route('panel.town-halls.edit', ['town_hall' => $townHall->id]) }}">{{ __('Edit Town Hall') }}</a>
        </li>
    </ol>
</nav>
...
<div class="card shadow-sm">
    <div class="card-header d-flex align-items-center bg-transparent border-0">
        <div class="card-title mb-0">{{ __('Edit Town Hall') }}</div>
    </div>

    <div class="card-body">
        <form action="{{ route('panel.town-halls.update', ['town_hall' => $townHall->id]) }}" method="post" autocomplete="off">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="code" value="{{ old('code', $townHall->code) }}" id="code" class="form-control @error('code') is-invalid @enderror">
                ...
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="ekatte" value="{{ old('ekatte', $townHall->ekatte) }}" id="ekatte" class="form-control @error('ekatte') is-invalid @enderror">
                ...
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $townHall->name) }}" id="name" class="form-control @error('name') is-invalid @enderror">
                ...
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        @php
                            $oldMunicipalities = old('municipality_id', $townHall->municipality_id);
                        @endphp
