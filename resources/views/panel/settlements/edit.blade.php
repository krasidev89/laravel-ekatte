...
@section('title', __('Edit Settlement'))
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb border bg-white shadow-sm">
        ...
        <li class="breadcrumb-item pr-1">
            <a href="{{ route('panel.settlements.edit', ['settlement' => $settlement->id]) }}">{{ __('Edit Settlement') }}</a>
        </li>
    </ol>
</nav>

<div class="card shadow-sm">
    <div class="card-header bg-transparent">{{ __('Edit Settlement') }}</div>
            ...
            <div class="row">
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="ekatte" value="{{ old('ekatte', $settlement->ekatte) }}" id="ekatte" class="form-control @error('ekatte') is-invalid @enderror">
                ...
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $settlement->name) }}" id="name" class="form-control @error('name') is-invalid @enderror">
