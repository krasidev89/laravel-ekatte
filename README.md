...
The project is a multilingual admin panel basically based on the [Laravel 11](https://laravel.com/docs/11.x/installation) and [Bootstrap 4](https://getbootstrap.com/docs/4.6/getting-started/introduction/).
...
- [Laravel Microservice Architecture](https://krisnacahyono.medium.com/laravel-microservice-architecture-d134da9f5c3f)
